...
public class VGUtils {
	...
	/**
	 * 
	 * Return the new string changed that are the cut text that have exactly the same count of delimiter that was defined by parameter.
	 * 
	 * NOTE:<br>
	 * Create this simple method because stringTokenizer not work just expected for this case.
	 * @param textLine
	 * @param delimiter
