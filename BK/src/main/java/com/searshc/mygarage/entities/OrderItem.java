...
public class OrderItem {
     ...
     */
    public String getPluPriceAmount() {
     ...
     */
    public void setPluPriceAmount(String pluPriceAmount) {
    ...
    /**
     * @return the miscAcctNumber
     */
    public String getMiscAcctNumber() {
        return miscAcctNumber;
    }

    /**
     * @param miscAcctNumber the miscAcctNumber to set
     */
    public void setMiscAcctNumber(String miscAcctNumber) {
        this.miscAcctNumber = miscAcctNumber;
    }
}
