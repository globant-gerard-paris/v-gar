...
/**
 * 
 * The {@link StoreService} have the responsibility to retrieve stores of the system.
 * 
 * @author Jero
 *
 */
...
public class StoreService {
	...
	/**
	 * 
	 * Retrieve the Stores near of given latitude, longitude and distance in miles that will limit
	 * the result.
	 * 
	 * @param latitude
	 *            The origin latitude that will be use to perform the search of stores near.
	 * @param longitude
	 *            The origin longitude that will be use to perform the search of stores near.
	 * @param distance
