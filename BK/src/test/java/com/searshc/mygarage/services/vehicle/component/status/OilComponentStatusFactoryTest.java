...
public class OilComponentStatusFactoryTest extends ComponentStatusFactoryConfigurer {
    ...
    public void localServiceShouldReturnOKStatus() {
        ...
        assertTrue(vehicleComponentStatusDTO.getStatusName().equalsIgnoreCase(OilStatus.FULL.name()));
        assertTrue(vehicleComponentStatusDTO.getStatusDescription().equalsIgnoreCase(OilStatus.FULL.getDescription()));
    }
